...
export class createSale1649205537652 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "sale" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "foodstoreId" integer, "deliveryId" integer, CONSTRAINT "REL_9c3df2981e06a9ee882c9835e2" UNIQUE ("foodstoreId"), CONSTRAINT "REL_bfa3717f3abad5107d587d5823" UNIQUE ("deliveryId"), CONSTRAINT "PK_d03891c457cbcd22974732b5de2" PRIMARY KEY ("id"))`);
