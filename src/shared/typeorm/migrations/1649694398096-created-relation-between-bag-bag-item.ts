...
export class createdRelationBetweenBagBagItem1649694398096 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "bags" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "cutomerId" integer, CONSTRAINT "REL_7a78a4b919e259dcaa53a367dc" UNIQUE ("cutomerId"), CONSTRAINT "PK_8ea1bfb4f475f35d6cffd0966ca" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "bags" ADD CONSTRAINT "FK_7a78a4b919e259dcaa53a367dc2" FOREIGN KEY ("cutomerId") REFERENCES "customers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
